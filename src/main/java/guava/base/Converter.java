 ...
 *
 * <ul>
 * <li>Use a provided converter implementation, such as Enums#stringConverter, com.google.common.primitives.Ints#stringConverter Ints.stringConverter or the {@linkplain
 *     #reverse reverse} views of these.
 * <li>Convert between specific preset values using com.google.common.collect.Maps#asConverter Maps.asConverter. For example, use this to create
 ...
 * <li>Use {@code converter} or {@code converter.reverse()} anywhere a java.util.function.Function is accepted (for example Stream#map).
