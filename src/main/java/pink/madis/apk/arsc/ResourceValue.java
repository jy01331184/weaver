...
public abstract class ResourceValue implements SerializableResource {
  ...
  public enum Type {
    ...
    /** The 'data' holds an attribute resource identifier, which needs to be resolved before it can be used like a TYPE_ATTRIBUTE. */
  ...
  /** set data of this ResourceValue */
  ...
  public static ResourceValue create(ByteBuffer buffer) {
    ...
    return new ResourceValueImpl(size, type, data);
  }
