...
public abstract class XmlAttribute implements SerializableResource {
  ...
  /** alipay added **/
  public abstract void setNamespaceIndex(int namespaceIndex);
  ...
  /** alipay added **/
  public abstract void setRawValueIndex(int rawValueIndex);
  ...
  public static XmlAttribute create(ByteBuffer buffer, XmlNodeChunk parent) {
    ...
    return new XmlAttributeImpl(namespace, name, rawValue, typedValue, parent);
  }
